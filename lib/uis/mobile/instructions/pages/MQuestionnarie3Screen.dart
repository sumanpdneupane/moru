...
class MQuestionnarie3Screen extends StatefulWidget {
  const MQuestionnarie3Screen({Key? key}) : super(key: key);

  @override
  State<MQuestionnarie3Screen> createState() => _MQuestionnarie3ScreenState();
}

class _MQuestionnarie3ScreenState extends State<MQuestionnarie3Screen> {
  String question = 'How would you rate you’r pain ?';
  ...
  saveToStore() {
    ...
    Routes.pushNamed(context, Routes.QUESTIONNARE_4_PAGE);
  }
